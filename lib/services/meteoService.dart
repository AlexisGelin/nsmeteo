...
class meteoService {
  static Future<CurrentWeatherData> requestMeteoData(
...
// http://api.openweathermap.org/geo/1.0/direct?q={city name},{state code},{country code}&limit={limit}&appid={API key}
  ...
  static CurrentWeatherData? getCurrentDataMeteo(
      cityModel city, String? units) {
    CurrentWeatherData? result;
    requestMeteoData(city, units).then((value) => result = value);
    return result;
  }
}
